...
client.on("messageCreate", message => {
    if(message.content == "<@934115799877161010>" || message.content == "<@!934115799877161010>") message.channel.send(`**Hey ${message.author.toString()}, il mio prefisso in questo server è __w!__**`)
})
