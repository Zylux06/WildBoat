...
module.exports = {
    ...
    execute(message, args) {
        ...
        var embed = new Discord.MessageEmbed()
            ...
            .setColor("RANDOM")
            .addField('Collaboratore:', `Grazie ${testo} per aver effettuato la Partnership con noi!`, true)
            .addField('Partner Manager', `${message.author.toString()} hai appena effettuato una Partner, bravo!`, true)
